...
<body>
	<header>
		...
		<h2 class="heading">Payment Calculator</h2>
		<p class="paymentmessage">(The Form Below Will Calculate How Much An Artist Needs To Be Paid)</p><br>

        <br><div>
        
        <form name="classForm" action="paymentchecker.php" method="POST" class="paymentform">

        <div>
			<br><label class="payment-info">Enter Hours Worked:</label><br>
			<br><input type="text" name="hours_worked" class="paymentinput" required="required" placeholder="E.g. 10 Hours"><br><br>
        </div>

        <div>
			<br><label class="payment-info">Enter Hourly Wage Rate:</label><br>
			<br><input type="text" name="wage_rate" class="paymentinput" required="required" placeholder="E.g. £12.50">
        </div>

        <div>
			<br><br><input name="calcpay" type="submit" value="Calculate Payment" class="submitclass">
		</div>
