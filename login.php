...
$con = new PDO('mysql:host=localhost;dbname=photographyart', 'root', '');
	if(isset($_POST['loginsubmit'])){
		...
		$select = $con->prepare("SELECT * FROM registered_users where username='$username' and password='$password' ");
...
<html lang="en">
<head>
	<title>PhotographyArt | User Login</title>
	...
	<header>
        ...
        <div class="registerform">
            <form action="" method="POST" enctype="multipart/form-data">
                ...
                <h2 class="artistheading">Enter Your Details To Login!</h2><br>
                ...
                <button class="submit" type="submit" value="Submit" name="loginsubmit">Submit</button><br>

                <br><br><a class="altlogin" href="register.php">Create An Account</a><br><br><hr>

                <br><a class="altlogin1" href="managerlogin.php">Manager Login</a><br><br>

                <a class="altlogin1" href="artistlogin.php">Artist Login</a><br><br>
