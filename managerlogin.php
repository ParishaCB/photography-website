...
$con = new PDO('mysql:host=localhost;dbname=photographyart', 'root', '');
	if(isset($_POST['loginsubmit'])){
		...
		$select = $con->prepare("SELECT * FROM managers where username='$username' and password='$password' ");
...
<html lang="en">
<head>
	<title>PhotographyArt | Manager Login</title>
	...
	<header>
        ...
        <div class="registerform">
            <form action="" method="POST" enctype="multipart/form-data">
                ...
                <h2 class="artistheading">Manager Login Area</h2><br>
                ...
                <br><a class= "altlogin1" href="login.php">Not A Manager? Click Here.</a><br><br>
